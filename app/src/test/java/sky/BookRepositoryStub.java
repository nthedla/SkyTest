...
public class BookRepositoryStub implements BookRepository {
    ...
    private static final String THE_NOT_FOUND = BOOK_REFERENCE_PREFIX + "999";
    ...
    static {
        ...
        books.put(BOOK_WITH_EMPTY_DESCRIPTION_REFERENCE, new Book(BOOK_WITH_EMPTY_DESCRIPTION_REFERENCE, "Empty Description", ""));
        books.put(BOOK_WITH_NULL_DESCRIPTION_REFERENCE, new Book(BOOK_WITH_NULL_DESCRIPTION_REFERENCE, "Null Description", null));
    }
